...
import com.example.macatedra_dsm.data.remote.UpdateEventRequest
...
fun EditEventScreen(
    ...
    LaunchedEffect(eventId) {
        try {
            ...
            val response = RetrofitClient.eventsApi.getEventById(
                token = "Bearer $token",
                eventId = eventId
            )
            ...
            errorMessage = "Error cargando evento: ${e.message}"
        } finally {
            isLoading = false
        }
    }
                            ...
                            Button(
                                ...
                                onClick = {
                                    ...
                                    if (
                                        ...
                                        errorMessage = "Completá todos los campos para actualizar el evento."
                                        return@Button
                                    }
                                    ...
                                    scope.launch {
                                        try {
                                            ...
                                            val response = RetrofitClient.eventsApi.updateEvent(
                                                token = "Bearer $token",
                                                eventId = eventId,
                                            ...
                                            errorMessage = "Error actualizando evento: ${e.message}"
                                        } finally {
                                            isSaving = false
                                        }
                                    }
